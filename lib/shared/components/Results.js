	...
	_createClass(Results, [{
		...
		value: function render() {
			...
			return _react2["default"].createElement(
				"div",
				{ style: { margin: "40px", display: "flex", flexWrap: "wrap", justifyContent: "center" } },
				this.state.resultsURIs ? this.state.resultsURIs.albums.items.map(function (album) {
					...
					return _react2["default"].createElement(
						"div",
						{ style: divStyle },
						_react2["default"].createElement("iframe", { style: frameStyle, src: source, width: "350", height: "430", frameborder: "0", allowtransparency: "false" })
					);
				}) : _react2["default"].createElement(
					"ol",
					{ className: "instruction", style: listStyle },
					_react2["default"].createElement(
						"li",
						{ style: itemStyle },
						"Search fot a song"
					...
					_react2["default"].createElement(
						"li",
						{ style: itemStyle },
						"Enjoy your non-mainstream song!"
					)
				)
			);
		}
